...
export default function UsdtV() {
  return (
    <div className="group rounded-md  p-8 flex text-center items-center justify-between bg-slate-500 w-full">
      <div className="flex items-center gap-2">
        ...
        <div>
          <p className="text-xl text-white font-semibold">USDT</p>
          <p className="text-gray-300">USDT</p>
        </div>
      </div>
